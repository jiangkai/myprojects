...
public class ResultList implements List<Object>{
	...
	public boolean add(Object e) {
		...
		return resultList.add((Map<String, Object>) e);
	}

	@Override
	public void add(int index, Object element) {
		resultList.add(index,(Map<String, Object>) element);
	}
	...
	public Object set(int index, Object element) {
		return resultList.set(index, (Map<String, Object>) element);
	}
